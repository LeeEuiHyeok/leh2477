...
#**6. 고찰 및 성찰**
 ...
 - 한준희 :이번 컴퓨터 시스템 설계 수업을 들으면서 git이라는 협업 프로그램을 사용하면서 상당히 편리하다는 점을 알 수 있었다. 또한               시스템 설계를 하면서 시스템에 대한 전반적인 설계 내용을 이해하는데 큼 도움이 되었다. 처음 시스템 아이디어를 창출하고                  아이디어를 설계하게되면서 많은 부분 부족하다는 생각이 들었다. 설계 하는 부분에서 아이디어 만으로도 가능 하다고 생각했지만,            막상 설계하려하니 전공 적으로 풍부한 지식을 가지고 그 지식을 기반으로 설계를 할수 있구나 라는 생각이들었다. 이전에는 과제를           하게되면 설계를 하기보다는 코딩을 하면서 이거저거 살을 붙이는 방법으로 진행 하였는데 이런 방식의 실계후 코딩으 하게되면               보다 쉽게 코딩작업을 할수 있겠다는 생각이 들었다. 한 학기 동안 수고 많으 셨습니다.
 - 이현수 : 한 학기동안 프로그램을 만들기 직전 단계까지 설계하는 과정과 GitHub을 통해 효율적인 문서작업과 협업을 할 수 있다는걸 배웠다. 설계하는 과정에서 많은 것을 배웠으며, 평소에는 코딩만 할 수 있으면 되는 줄 알았는데 수업을 들은 후 설계하는 능력이 뒷받침 되지 않으면 힘들다는 것을 배웠다. 이를 통해 다음에 하는 텀프로젝트, 기타 설계과목, 졸업설계를 더욱 쉽게 접근할 수 있을 것 같다.
